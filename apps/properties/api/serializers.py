...
class PropertySerializer(serializers.ModelSerializer):
    ...
    def get_images(self, obj):
        ...
        images_list = [settings.API_HOST + "static/images/properties/" + str(obj.id) + "/" + f for f in
                       listdir(image_path) if isfile(join(image_path, f))]
    ...
    class Meta:
        ...
        fields = (
            ...
            'security_deposit', 'publication_date', 'available_to_move_in_date', 'open_view_available', 'open_view_start',
            'open_view_end',
