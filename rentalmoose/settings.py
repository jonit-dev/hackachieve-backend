...
if ENV == "prod":
    DEBUG = False
    API_HOST = 'https://www.therentalmoose.com:8000/'
...
INSTALLED_APPS = [
    ...
    'apps.provinces',
    'apps.places',
    'apps.user_property_filter',
    'apps.user_property_filter_property_types',
    'apps.cities',
    'apps.resumes',
    'apps.properties',
    'apps.property_types',
...
CRONJOBS = [
    ...
    ('0 9 */3 * *', 'cronjobs.cron.check_resume_matches','>> {}/cron.log'.format(LOGS_PATH)) #production - every two days at 9am
